# Az utolsó hírlevél – ha segítesz, akkor lesz folytatás…

Szia,

Szalai Kálmán vagyok, ennek a hírlevélnek a szerkesztője és szabad szoftver aktivista. A Szabad szoftver és kultúra hírévél két éve indult, hogy beszámoljon a szabad szoftverekkel és kultúrával kapcsolatos hírekről és fejleményekről. Két éve lelkesen készítjük szabadidőnkben, önkéntesen, hogy növeljük a szabad szoftverek hazai ismertségén. Mivel 2018. május 25-én hatályba lép az Európai Adatvédelmi rendelet ([General Data Protection Regulation 2016/679]((eur-lex.europa.eu/legal-content/HU/TXT/HTML/?uri=CELEX:32016R0679&from=HU))) és szeretnénk az általa támasztott kívánalmaknak megfelelni, ezért a hírlevél alján közzétesszük a hírlevéllel kapcsolatos adatvédelmi nyilatkozatot, amelyet szeretnénk, ha elfogadnál.

A általam kezelt adatokat, az elmúlt 10 év során, rendezvényeken adtad meg számomra, vagy munkatársaim számára, illetve a [Szabad Szoftver és Kultúra Hírlevél űrlapon jelentkezhettél](http://eepurl.com/cqj9pv). Szeretném, hogy továbbra is a lista tagja maradj. Nem fogunk spammelni, kereskedelmi tartalmakról írni, az email-címlistát értékesíteni, átadni, csak erre a hírlevél tartalomra koncentráltan tudásunk legjavát átadni Neked. Örülnék neki, ha szeretnél kapni ebből a hírlevélből havonta 1 (maximum 2) új kiadást.

Szóval ha velünk tartasz a továbbiakban is, annak nagyon örülnék.

[Itt tudsz az új listára feliratkozni](http://eepurl.com/dvYejT)

Ha bizonytalan lennél, kérlek olvasd el e havi hírlevelünket, és bízom benne ez meggyőz Téged arról, hogy érdemes a listán maradni.

A meglévő listát 2018. május 25-én töröljük.

[Ne feledd, szabadon sokkal jobb!](http://eepurl.com/dvYejT)

Baráti üdvözlettel,

Szalai Kálmán szerkesztő
és
a hírlevél készítői
...
Mint ahogy az új szabad szoftver kiadások részben majd olvashatod, megjelent a Gimp legújabb verziója. Ennek kapcsán, arra gondoltunk, ebben a hónapban a Gimp képszerkesztővel kapcsolatos képességeidet bővítjük. A GIMP (GNU Image Manipulation Program) egy rendkívül nagytudású bittérképes vagy más néven pixelgrafikus képszerkesztő program, amely elérhető majd minden operációs rendszerre, így van Windows, Linux és Mac OS X változata is.

A [Gimp több mint 20 éve jelent meg](http://grafit.netpositive.hu/boldog-20-szulinapot-gimp/) és vált a multiplatform szabad képszerkesztés ikonjává. A program ikonja, kabalafigurája Wilber, aki leginkább egy kis farkasra hasonlít. 1997 óta használják kabalaállatként. A Gimppel kapcsolatos alapinformációk begyűjtéséhez a [Gimp magyar oldala](http://gimp.hu/) és az [angol oldal](https://www.gimp.org/) mellett számos oldalon találhattok segítséget.

A magyar nyelvű olvasnivalók közül ajánljuk Baráth Gábor: GIMP könyv című könyvét, melyet [minden érdeklődő ingyenesen letölthet](http://gimp.hu/konyv/gimp_konyv_kozepes.pdf). Vannak [további ingyenesen elérhető oktató anyagok is](http://tehetseg.inf.elte.hu/tananyagok/kepszerk/) és [itt is](http://ilias.gdf.hu/data/ilias-ha/lm_data/lm_88098/gimpvilaga/index.html). A YouTube is tele van gimp-es oktatóvideókkal, [például ezzel](https://www.youtube.com/watch?v=_SyhQj-AMyM&list=PLQCrW4xBBP-QmQ5JpqdBkjjbRSaYKqKXk).
...
Már hat éve, hogy megjelent a GIMP 2.8-as változata, az azóta eltelt időben pedig a fejlesztői csapat azon dolgozott, hogy valami igazán ütőset tudjanak összehozni a következő nagy frissítésre, ami most meg is érkezett a 2.10-es variánssal.

A 2.10-es GIMP az eddigi legnagyobb frissítési csomag, ezt a csapat is elismerte, így javításokból és újdonságokból is akad bőven, valamint a felhasználói felület is jelentősen átalakult. Utóbbit érinti hogy sötét lett az alap felület (összesen négy téma van) és alapvetően szürkére váltottak mindenhol az ikonok az eddigi színesek helyett.

A változtatások között találjuk még a jobb HiDPI támogatást, erre nagy hangsúly került a fejlesztés során, ugyanis évről évre egyre modernebb kijelzők kerülnek piacra. Kaptunk több, variálható témát, valamint mostantól még több képformátumot támogat a GIMP, többek közt az OpenEXR-t, WebP-t, HFT-t és RGBE-t.

A változtatások teljes listája:  fGIMP 2.10 Release Notes](https://www.gimp.org/release-notes/gimp-2.10.html)

[Letöltés](https://www.gimp.org/downloads/)

([forrás](http://androgeek.hu/hir/megjott-a-gimp-eddigi-legnagyobb-frissitese-itt-a-210es-verzio))
...
## A szabad szoftverekkel és szabad kultúrával kapcsolatos hírlevél küldéséhez

### Nyilatkozat

* Alulírott az [információs önrendelkezési jogról és az információszabadságról szóló 2011. évi CXII. törvény](net.jogtar.hu/jogszabaly?docid=A1100112.TV) (a továbbiakban Infotv), valamint az [európai általános adatvédelmi 2016/679. rendelet](eur-lex.europa.eu/legal-content/HU/TXT/HTML/?uri=CELEX:32016R0679&from=HU) rendelkezései alapján hozzájárulásomat adom a Szalai Kálmán szabad szoftveres önkéntes (a továbbiakban Adatkezelő) részére, hogy a szabad szoftverekkel és szabad kultúrával kapcsolatos hírlevelek kiküldésével összefüggésben az átadott személyes adataimat nyilvántartsa és kezelje.
* Adatkezelő vonatkozásában tudomásul veszem, hogy:
1. Az adatkezelés célja: A szabad szoftverekkel és szabad kultúrával kapcsolatos hírlevelek kiküldése a felhasználó által megadott e-mail címre.
...
3. Az adatkezelés időtartama: a törvényben meghatározottak szerint a hírlevélről történő leiratkozásig. Az Adatkezelő a személyes adatokat a hozzájárulásának visszavonásáig kezeli.
4. Az Adatkezelő által kezelendő személyes adatok köre:
        ...
        Irányítószám (nem kötelező). Település (nem kötelező), Születési év (nem kötelező), Születésnap (nem kötelező)
...
Az Adatkezelő megfelelő intézkedésekkel gondoskodik arról, hogy a személyes adatait védje többek között: a jogosulatlan hozzáférés ellen, vagy azok jogosulatlan megváltoztatása
